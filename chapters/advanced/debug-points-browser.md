...
![Debug Point Browser, opened via the World menu.%width=70&label=fig:dp-browser](./graphics/debug-points-browser.png)
...
![Debug Point Browser with a selected debug point set on an instance variable.%width=70&label=fig:dp-browser-variable](./graphics/debug-points-browser-variable.png )
...
![Filtering the displayed debug points by name, thanks to an input field.%width=70&label=fig:dp-browser-filter](./graphics/debug-points-browser-filter-by-name.png )
...
![Popover button menu, suggesting to insall object-centric debug points for an object on all instance variables.% width=75&label=fig:dp-oc-popover](./graphics/debug-points-object-centric-popover-button.png)
...
![Context menu on an instance variable in the raw inspector, suggesting to install object-centric debug points for the selected variable only.%width=35&label=fig:dp-raw-inspector-context-menu](./graphics/debug-points-object-centric-raw-context-menu.png )
...
![Context menu on a method in the meta tab of the inspector, suggesting to install objec-centric debug points for the selected method.% width=35&label=fig:dp-meta-context-menu](./graphics/debug-points-object-centric-break-on-call.png)
...
![Modal opened to choose a debug point whose scope should be changed to the inspected object % width=70&label=fig:dp-inspector-set-scope.](./graphics/debug-points-set-object-centric-scope-modal.png)
...
![Drag and drop of debug points to create a debug point chain.%width=70&label=fig:dp-drag-drop](./graphics/debug-points-drag-drop.png)
...
![Created debug point chain via drag and drop.%width=70&label=fig:dp-created-chain](./graphics/debug-points-created-chain.png )
